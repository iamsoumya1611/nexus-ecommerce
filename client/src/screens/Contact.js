      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-brown-100 rounded-full flex items-center justify-center mr-4">
                  <i className="fas fa-map-marker-alt text-brown-700"></i>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-brown-900">Our Location</h3>
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-brown-100 rounded-full flex items-center justify-center mr-4">
                  <i className="fas fa-phone-alt text-brown-700"></i>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-brown-900">Phone Number</h3>
                  <p className="text-brown-700">
                    +1 (555) 123-4567<br />
                    +1 (555) 987-6543
                  </p>
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-brown-100 rounded-full flex items-center justify-center mr-4">
                  <i className="fas fa-envelope text-brown-700"></i>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-brown-900">Email Address</h3>
                  <p className="text-brown-700">
              ...
              <div className="flex items-start">
                <div className="flex-shrink-0 w-12 h-12 bg-brown-100 rounded-full flex items-center justify-center mr-4">
                  <i className="fas fa-clock text-brown-700"></i>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-brown-900">Business Hours</h3>
                  <p className="text-brown-700">
            ...
            <div className="mt-8">
              <h3 className="text-lg font-semibold text-brown-900 mb-4">Follow Us</h3>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-brown-700 text-white rounded-full flex items-center justify-center hover:bg-brown-800 transition-colors">
