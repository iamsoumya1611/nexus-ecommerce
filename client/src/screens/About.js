  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-primary-900 mb-8 text-center">Why Choose Us</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 card">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-shipping-fast text-primary-700 text-2xl"></i>
              </div>
              <h3 className="text-xl font-bold text-primary-900 mb-2">Fast Shipping</h3>
            ...
            <div className="text-center p-6 card">
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-undo text-primary-700 text-2xl"></i>
              </div>
              <h3 className="text-xl font-bold text-primary-900 mb-2">Easy Returns</h3>
              <p className="text-primary-700">
        ...
        <div className="bg-primary-100 rounded-xl p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <span className="bg-white text-primary-700 px-4 py-2 rounded-full">Eco-Friendly</span>
            <span className="bg-white text-primary-700 px-4 py-2 rounded-full">Ethically Sourced</span>
            <span className="bg-white text-primary-700 px-4 py-2 rounded-full">Community Support</span>
          </div>
        </div>
      </div>
    </div>
